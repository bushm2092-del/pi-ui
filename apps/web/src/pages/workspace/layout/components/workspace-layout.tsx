    ...
    <>
      ...
      <div
        {...({
          ...
          style: {
            "--spacing-token-safe-header-left": "88px",
      ...
      <span
        {...({
          className:
            "pointer-events-none fixed inset-0 z-[60] mx-auto my-2 flex max-w-(--composer-adjacent-max-width) flex-col items-center justify-start md:pb-5",
        } as any)}
      />
    </>
  );

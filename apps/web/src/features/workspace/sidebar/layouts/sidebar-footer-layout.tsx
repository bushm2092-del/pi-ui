        ...
        <div {...({"className":"flex h-toolbar items-center gap-2 px-row-x"} as any)}>
          <div {...({"className":"min-w-0 flex-1"} as any)}>
            <div {...({"className":"flex min-w-0 flex-1 items-center gap-0 sidebar-item"} as any)}>
              <button {...({"className":"outline-hidden cursor-interaction flex h-[var(--height-token-row)] min-w-0 flex-1 cursor-interaction items-center gap-2 sidebar-item px-[var(--padding-row-cell-x,var(--padding-row-x))] text-left text-base text-token-foreground outline-none hover:bg-token-list-hover-background focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-token-border","type":"button","aria-label":"打开个人资料菜单","id":"radix-_r_h5_","aria-haspopup":"menu","aria-expanded":"false","data-state":"closed"} as any)}>

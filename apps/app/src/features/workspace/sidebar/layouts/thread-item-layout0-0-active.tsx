...
export function ThreadItemLayout0_0_Active({ slots = {}, rootProps = {} }: LayoutProps = {}) {
  return (
    <div {...({"className":"after:block after:h-px after:content-[''] last:after:hidden","role":"listitem","style":{"transition":"transform linear"}} as any)} {...rootProps}>
      <div {...({"className":"cursor-grab active:cursor-grabbing","role":"button","tabIndex":"0","aria-disabled":"false","aria-roledescription":"sortable","aria-describedby":"DndDescribedBy-3"} as any)}>
        <div {...({"className":"overflow-hidden","style":{"height":"auto","opacity":"1","overflow":"visible"}} as any)}>
          <div {...({"data-app-action-sidebar-thread-active":"true","data-app-action-sidebar-thread-host-id":"local","data-app-action-sidebar-thread-id":"local:019fc7cf-3317-7581-9a84-b831acb22c44","data-app-action-sidebar-thread-kind":"local","data-app-action-sidebar-thread-pinned":"false","data-app-action-sidebar-thread-row":"","data-app-action-sidebar-thread-title":"Launch ChatGPT with debugging","className":"group relative cursor-interaction py-row-y text-sm hover:bg-token-list-hover-background focus-visible:outline-offset-[-2px] h-[var(--height-token-row)] sidebar-item pe-1 ps-[var(--padding-row-cell-x,var(--padding-row-x))] bg-token-list-hover-background","role":"button","tabIndex":"0","aria-label":"Launch ChatGPT with debugging","data-state":"closed","aria-current":"page"} as any)}>
            ...
            <div {...({"data-hover-card-open-immediately":"true","className":"flex shrink-0 items-center justify-end absolute end-0 top-0 z-10 flex h-full min-w-[52px] items-center justify-end gap-2 pe-1 group-hover:hidden group-has-[:focus-visible]:hidden"} as any)}>
              <span {...({"className":"flex h-5 min-w-5 items-center justify-center"} as any)}>
                <div {...({"className":"relative flex size-5 shrink-0 items-center justify-center text-token-foreground/70"} as any)}>
                  <div {...({"className":"animate-spin inline-flex h-fit w-fit items-center justify-center leading-none contain-layout contain-paint contain-style","style":{"animationDelay":"-338ms","animationDuration":"2000ms"}} as any)}>
                    <svg {...({"width":"24","height":"24","viewBox":"0 0 24 24","fill":"none","xmlns":"http://www.w3.org/2000/svg","className":"icon-xs shrink-0"} as any)}>
                      <path {...({"opacity":"0.3","d":"M18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18C15.3137 18 18 15.3137 18 12ZM20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12Z","fill":"currentColor"} as any)} />
                      <path {...({"d":"M12 4C16.4183 4 20 7.58172 20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12H6C6 15.3137 8.68629 18 12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6V4Z","fill":"currentColor"} as any)} />
                    </svg>
                  </div>
                </div>
              </span>
            ...
            <div {...({"className":"flex h-full w-full items-center text-sm leading-4"} as any)}>
              <div {...({"className":"flex min-w-0 flex-1 items-center gap-2"} as any)}>
                ...
                <div {...({"className":"flex min-w-0 flex-1 self-stretch text-base leading-5 items-center gap-2 text-token-foreground","data-thread-title-trigger":"true"} as any)}>
                  <span {...({"data-thread-title":"true","id":"_r_fe_","className":"_viewport_1ozkg_1 _animateOnGroupHover_1ozkg_53 min-w-0 select-none flex-1","data-marquee-text":"true","draggable":"false","data-marquee-overflowing":"true","data-marquee-animatable":"true"} as any)}>
                    <span {...({"className":"_clipViewport_1ozkg_13 _overflowingViewport_1ozkg_33"} as any)}>

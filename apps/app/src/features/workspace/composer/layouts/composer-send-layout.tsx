export function ComposerSendLayout({
  ...
  return (
    <button {...({"type":"button","className":"cursor-interaction size-token-button-composer flex items-center justify-center rounded-full transition-opacity focus-visible:outline-2 bg-token-foreground p-0.5 focus-visible:outline-token-button-background","aria-label":"发送"} as any)} disabled={disabled} onClick={onClick}>
